...
class ResNetYoloV1(nn.Module):
    ...
    def __init__(self, block, layers, num_boxes=2, num_classes=20, zero_init_residual=False):
...
def resnet50_yolov1(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model for Yolo.
